...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Zambagarrah</h1>
        <h3 className="home__subtitle">Visual Designer</h3>
        <p className="home__description">I'm a creative designer based in Nakuru, Kenya and I'm very passionate and dedicated to my work.</p>
